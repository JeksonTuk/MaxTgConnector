...
def test_error_classification_pauses_reconnect_after_auth_rate_limit():
    issue = max_errors.classify_runtime_error(
        RuntimeError(
    ...
    assert issue.kind == max_errors.MAX_AUTH_RATE_LIMITED_KIND
