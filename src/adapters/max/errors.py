...
MAX_AUTH_RATE_LIMITED_KIND = "max_auth_rate_limited"
...
def is_auth_rate_limited(error: BaseException) -> bool:
    """Распознать временный лимит именно на запрос SMS-кода MAX."""
    lowered = _error_text_with_context(error).lower()
    has_limit_marker = "limit.violate" in lowered
    ...
    return has_limit_marker and has_auth_message
