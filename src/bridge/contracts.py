...
@dataclass
class TelegramReactionAction:
    """Reaction set or cleared in a Telegram topic, routed into bridge core."""

    tg_msg_id: int
    #: None означает, что реакция снята.
...
class TelegramBridgePort(Protocol):
    ...
    async def set_message_reaction(
        self, tg_msg_id: int, reaction: str, *, flow_id: Optional[str] = None
    ) -> bool: ...
